...
def doppler_resolution(band_width, start_freq_const=60, ramp_end_time=36, idle_time_const=15, num_loops_per_frame=1,
                       num_tx_antennas=1):
